$(document).ready(function() {
    ...
    function handleRemovalUncheckedProduct(tr) {
        ...
        $('#ciqual_table input:checkbox').each(function() {
            $(this).change(function() {
                ...
                // Si on vient de décocher l'élément écouté
                    ...
                    handleRemovalUncheckedProduct(tr);
                }
            });                   
        });    
    }
    ...
    function addToCheckedElementsRecap(product) {
        console.log("DANS LA FONCTION addToCheckedElementsRecap !!!!!!!!!!!!");
        let checkedElementLiStr = '<li class="checked-element"><span class="delete-btn"><i class="fas fa-trash-alt"></i></span>';
        checkedElementLiStr += (product.nom + '</li>')
